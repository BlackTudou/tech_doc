...
platform identity：平台指的是这一类的产品，比如说什么什么系列

platform instance indentity：平台实例就具体到了某个具体产品和设备，芯片的话，是要求每个芯片有自己的唯一序列号的
...
Read the UID from PUF cell. These registers are labeled puf_000~puf_031. Each PUF location
provides 32 bits static entropy (after enrollment) which can act as a silicon fingerprint for the
various security applications of identification, authentication, and local data protection.

OTP 通过 AHB 接口连接，32bits 数据总线与代码总线。
